...
<Box
  width="100%"
  minW="100%" // Set minW to 100% to occupy the full width
  pt="50px" // Adjust this value to reduce the padding above the content inside the box
  height="900px"
  backgroundColor="white"
  borderRadius="xl"
  maxWidth="1200px" // Set a maximum width if necessary
>
  <VStack spacing={5}>
    <HStack spacing={2}>
      <Box width="100%" minW="100%" pt="50px" height="20px">
        <Box
          borderWidth="1px"
          borderColor="gray.300"
          borderRadius="md"
